...
def populate():
    ...
    glasgow_reviews = {'Uber':{'userID':user1.id,'location':'glasgow','service':'Uber','rating':3,'title':'Slow connection to uber','body':"Took a while to connect to an uber and the driver as not as friendly as other taxis I've taken.",'likes':5},
                        'GlasGo':{'userID':user3.id,'location':'glasgow','service':'GlasGo','rating':1,'title':'Would not reccomend this taxi','body':"Absolutely shocking service! App is telling me I have a 4 minute wait for a taxi so I booked! Iv waited the best part of an hour for the taxi to arrive! When I phoned they couldn't tell me how long I will be waiting! I could have got a bus faster!",'likes':2},
    ...
    edinburgh_reviews = {'Uber':{'userID':user2.id,'location':'edinburgh','service':'Uber','rating':5,'title':'Speedy cab with friendly and helpful. driver','body':"Was fast and easy to find an uber. The driver was very friendly and gave us good recommendations for places to go and eat.",'likes':13},
                        'City Cabs':{'userID':user4.id,'location':'glasgow','service':'City Cabs','rating':3,'title':'Not great for booking a cab in advanced','body':'I could only book on the app if I wanted to book the taxi to the airport for the next morning, so I had to call and hope for a taxi to come at 4am.','likes':4},
